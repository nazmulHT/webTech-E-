...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  <br><br>
  Degree:
  <input type="checkbox" id="ssc" name="degree[1]" value="SSC">SSC
  <input type="checkbox" id="hsc" name="degree[2]" value="HSC">HSC
  <input type="checkbox" id="bsc" name="degree[3]" value="BSc">BSc
  <input type="checkbox" id="msc" name="degree[4]" value="MSc">MSc
